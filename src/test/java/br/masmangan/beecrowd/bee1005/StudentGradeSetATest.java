...
public class StudentGradeSetATest {
	...
	public void testSetAWithValidValue() {
		...
		assertEquals(inputValue, studentGrade.getA(), "Should correctly save value of A");
	}
	...
	public void testSetAWithMaxDoubleValue() {
		...
		studentGrade.setA(inputValue);
		assertEquals(inputValue, studentGrade.getA(), "Should correctly save maximum double value of A");
	}

	@Test
	public void testSetAWithMinDoubleValue() {
		double inputValue = Double.MIN_VALUE;
		studentGrade.setA(inputValue);
		assertEquals(inputValue, studentGrade.getA(), "Should correctly save minimum double value of A");
	}
	...
	public void testSetAWithNegativeValue() {
		double inputValue = -5.0;
		studentGrade.setA(inputValue);
		assertEquals(inputValue, studentGrade.getA(), "Should correctly handle negative value of A");
	}
