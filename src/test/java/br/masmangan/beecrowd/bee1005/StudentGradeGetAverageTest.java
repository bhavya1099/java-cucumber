...
File Path: /var/tmp/Roost/RoostGPT/javaspring-unit-test/1736998236/source/java-cucumber/src/test/java/br/masmangan/beecrowd/bee1005/StudentGradeSteps.java
Tests:
    "@Test
...
File Path: /var/tmp/Roost/RoostGPT/javaspring-unit-test/1736998236/source/java-cucumber/src/test/java/br/masmangan/beecrowd/bee1006/StudentGradeSteps.java
Tests:
    "@Test
@When("average is calculated")
public void average_is_calculated() {
...
Details:
  ...
  Execution:
    ...
    Assert: Use JUnit assertions to compare the actual result with the expected average.
  Validation:
    The assertion verifies that the average calculation is correct when both a and b are positive numbers. This is important as it ensures the functionality of the getAverage() method in normal use cases.
...
Details:
  ...
  Execution:
    ...
    Assert: Use JUnit assertions to compare the actual result with the expected average.
  Validation:
    The assertion verifies that the average calculation is correct when both a and b are negative numbers. This is important as it ensures the functionality of the getAverage() method in edge cases.
...
Details:
  ...
  Execution:
    Arrange: Use the setA() and setB() methods to set a or b to zero.
    Act: Invoke the getAverage() method.
    Assert: Use JUnit assertions to compare the actual result with the expected average.
  Validation:
    The assertion verifies that the average calculation is correct when either a or b is zero. This is important as it ensures the functionality of the getAverage() method in edge cases.
...
Details:
  ...
  Execution:
    ...
    Assert: Use JUnit assertions to compare the actual result with the expected average.
  Validation:
    The assertion verifies that the average calculation is correct when both a and b are maximum double values. This is important as it ensures the functionality of the getAverage() method in extreme cases.
*/
...
public class StudentGradeGetAverageTest {
	...
	public void testValidAverageWithZero() {
		...
		studentGrade.setB(20.0);
		double expected = (0.0 * 3.5 + 20.0 * 7.5) / 11.0;
		assertEquals(expected, studentGrade.getAverage());
	}
