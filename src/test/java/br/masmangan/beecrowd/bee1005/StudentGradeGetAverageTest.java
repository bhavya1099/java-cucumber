...
public class StudentGradeGetAverageTest {
	...
	public void testGetAverageWithNegativeNumbers() {
		...
		double result = student.getAverage();
		// Assert
		// Comment: The business logic in getAverage method should handle
		// the case when negative values are used as inputs.
		assertEquals(
				"The business logic in getAverage method should handle the case when negative values are used as inputs.",
				-3.68, result, 0.01);
	}
