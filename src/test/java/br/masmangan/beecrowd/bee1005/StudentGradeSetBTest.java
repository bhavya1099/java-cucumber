...
import com.yourpackage.Student; // Correct import for Student class
...
public class StudentGradeSetBTest {
	...
	public void testSetPositiveValueForB() {
		...
		student.setB(1.0);
		assertEquals(1.0, student.b, 0.001);
	}
	...
	public void testSetZeroValueForB() {
		Student student = new Student();
		student.setB(0);
		assertEquals(0, student.b, 0.001);
	}
	...
	public void testSetLargeValueForB() {
		...
		student.setB(largeValue);
		assertEquals(largeValue, student.b, 0.001);
	}

	@Test
	public void testSetSmallDecimalValueForB() {
		Student student = new Student();
		student.setB(0.000000001);
		assertEquals(0.000000001, student.b, 0.000000001);
	}
