...
public class StudentGradeSetBTest {
    ...
    public void setNormalValueForB() {
        ...
        assertEquals("Average should correctly reflect the set value of b.", expected, studentGrade.getAverage(), 0.0001);
    }
    @Test
    ...
    public void setZeroForB() {
        ...
        assertEquals("Average should correctly reflect the zero value of b.", expected, studentGrade.getAverage(), 0.0001);
    }
    @Test
    ...
    public void setNegativeValueForB() {
        ...
        assertEquals("Average should correctly reflect the negative value of b.", expected, studentGrade.getAverage(), 0.0001);
    }
    @Test
    @Category(Categories.boundary.class)
