...
public class CircleGetAreaTest {
	...
	private void testCircleArea(double radius, double expectedArea) {
		Circle circle = new Circle();
		try {
			circle.setRadius(radius);
			assertEquals("Area with radius " + radius + " is incorrect", expectedArea, circle.getArea(), 0.00001);
		}
	...
	public void testAreaWithPositiveRadius() {
		testCircleArea(5, PI * 5 * 5);
	}

	@Test
	public void testAreaWithNegativeRadius() {
		testCircleArea(-5, 0); // Should hit IllegalArgumentException
	}
	...
	public void testAreaWithMaxPositiveRadius() {
		testCircleArea(Double.MAX_VALUE, PI * Double.MAX_VALUE * Double.MAX_VALUE);
	}
