...
public class CircleGetAreaTest {
	...
	public void testGetAreaWithNegativeRadius() {
		radius = -5;
		assertThrows(IllegalArgumentException.class, () -> getArea());
		// No expected value for a negative radius as this will throw an
	...
	public double getArea() {
		// Throws an IllegalArgumentException when radius is negative.
		if (radius < 0) {
