...
public class CircleGetAreaTest {
	...
	/*
	 * This test case is expecting an IllegalArgumentException when a negative radius is
	 * passed. Check the setRadius() method in Circle class and ensure that it throws
	 * IllegalArgumentException for negative radius.
	 */
