...
public class StudentGradeSetCTest {
	...
	public void setCWithValidValue() {
		...
		studentGrade.setA(90.0); // TODO: Adjust value as needed for specific test
									// scenario
		studentGrade.setB(80.0); // TODO: Adjust value as needed for specific test
									// scenario
		studentGrade.setC(85.0);
		double expectedAverage = (90.0 * 2 + 80.0 * 3 + 85.0 * 5) / 10.0;
		assertEquals("The average should correctly reflect the set value for C", expectedAverage,
	...
	public void setCWithNegativeValue() {
		...
		assertEquals("The average should handle negative values for C", expectedAverage, studentGrade.getAverage(),
				0.001);
	}
	...
	public void setCWithExtremelyHighValue() {
		...
		assertEquals("The average should handle extremely high values for C", expectedAverage,
				studentGrade.getAverage(), 0.001);
	}
	...
	public void setCWithDecimalValue() {
		...
		assertEquals("The average should accurately calculate with decimal values for C", expectedAverage,
				studentGrade.getAverage(), 0.001);
	}
