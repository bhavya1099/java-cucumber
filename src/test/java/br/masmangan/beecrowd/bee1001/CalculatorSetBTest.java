...
public class CalculatorSetBTest {
	...
	@Test
	public void testSetBWithValidParameter() {
		int expectedValue = 5;
		calculator.setB(expectedValue);
		Assert.assertEquals("b variable should be properly set", expectedValue, calculator.getB());
	}
	...
	public void testSetBWithZero() {
		int expectedValue = 0;
		calculator.setB(expectedValue);
		Assert.assertEquals("b variable should be set to zero", expectedValue, calculator.getB());
	}

	@Test
	public void testSetBWithNegativeParameter() {
		int expectedValue = -5;
		calculator.setB(expectedValue);
		Assert.assertEquals("b variable should be set to negative", expectedValue, calculator.getB());
	}

	@Test
	public void testSetBWithMaxInteger() {
		int expectedValue = Integer.MAX_VALUE;
		calculator.setB(expectedValue);
		Assert.assertEquals("b variable should be set to maximum integer value", expectedValue, calculator.getB());
	}
