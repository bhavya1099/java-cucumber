...
public class CalculatorSetATest {
	...
	public void testIfVariableAIsSetProperly() {
		calculator.setA(10);
		/*
		 * Here the getA method is missing in Calculator class. For this test scenario to
		 * work, the following getter method needs to be added in the Calculator class.
	...
	public void testIfSetADoesNotAffectOthers() {
		...
		calculator.setA(20);
		/*
		 * Here the getB method is missing in Calculator class. For this test scenario to
		 * work, the following getter method needs to be added in the Calculator class.
